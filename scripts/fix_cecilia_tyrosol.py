...
OUT_PATH = "/media/DATA_18_TB_2/andy/tica_sampled_starting_poses/BBA_TYR_fixed"

subprocess.run(["rm", "-r", OUT_PATH])
subprocess.run(["mkdir", OUT_PATH])
for pdb in glob.glob('/media/DATA_18_TB_2/andy/tica_sampled_starting_poses/BBA/*.pdb'):
    print("DOING", pdb)
